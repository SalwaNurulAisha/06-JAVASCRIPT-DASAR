...
const gajiBonus = 10/100*5000000;
const gajiLembur = 5/100*5000000;

const Pengeluaran = gundam+makan+kost+subscription;
const gajiBonusLembur = gajiBonus+gajiLembur;

const sisaGaji = gajiPokok+gajiBonusLembur-Pengeluaran;
